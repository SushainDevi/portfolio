...
import { u as useInViewport, c as cssProps, r as resolveSrcFromSrcSet } from "./server-build-CJzqNKMp.js";
...
import "three-stdlib";
const carousel = "_carousel_7jtir_3";
const content = "_content_7jtir_11";
const imageWrapper = "_imageWrapper_7jtir_23";
const canvasWrapper = "_canvasWrapper_7jtir_47";
const canvas = "_canvas_7jtir_47";
const placeholder = "_placeholder_7jtir_73";
const button = "_button_7jtir_103";
const nav = "_nav_7jtir_215";
const navButton = "_navButton_7jtir_229";
const styles = {
  carousel,
  content,
  imageWrapper,
